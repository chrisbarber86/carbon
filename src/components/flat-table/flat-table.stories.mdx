...
import { FlatTable, FlatTableHead, FlatTableBody, FlatTableRow, FlatTableHeader, FlatTableRowHeader, FlatTableCell, FlatTableSortHeader } from '.';
...
<Preview>
  <Story name="with transparent effect" parameters={{ info: { disable: true }}} >
...
<Preview>
  <Story name="with dark team" parameters={{ info: { disable: true }}} >
...
<Preview>
  <Story name="with light team" parameters={{ info: { disable: true }}} >
